...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 The MCP helper refuses to use token files with group/world permissions.
- [x] #2 Token read logic is shared or kept behaviorally identical between the app and helper.
