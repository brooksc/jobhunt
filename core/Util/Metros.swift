...
public let metroData: [String: StateInfo] = [
    ...
    "ca": StateInfo(label: "California", metros: [
        ...
        "san-diego": MetroInfo(
            label: "San Diego",
            cities: ["San Diego", "La Jolla", "Carlsbad", "Solana Beach", "Del Mar", "Chula Vista", "El Cajon"]
        ),
        "sacramento": MetroInfo(
            label: "Sacramento",
            cities: ["Sacramento", "Roseville", "Folsom", "Elk Grove", "Davis", "Rancho Cordova"]
        )
    ]),
    "tx": StateInfo(label: "Texas", metros: [
        ...
        "houston": MetroInfo(
            label: "Houston",
            cities: ["Houston", "Sugar Land", "The Woodlands", "Pearland", "Katy", "Stafford", "Clear Lake"]
        ),
    ...
    "or": StateInfo(label: "Oregon", metros: [
        "portland": MetroInfo(
            ...
            cities: ["Portland", "Beaverton", "Hillsboro", "Lake Oswego", "Tigard", "Vancouver", "Gresham", "Tualatin"]
        )
    ]),
    ...
    "nc": StateInfo(label: "North Carolina", metros: [
        "research-triangle": MetroInfo(
            label: "Research Triangle",
            cities: ["Raleigh", "Durham", "Chapel Hill", "Cary", "Morrisville", "Apex", "Holly Springs"]
        ),
        "charlotte": MetroInfo(
            label: "Charlotte",
            cities: ["Charlotte", "Concord", "Gastonia", "Matthews", "Huntersville"]
        )
    ]),
    "fl": StateInfo(label: "Florida", metros: [
        "miami": MetroInfo(
            label: "Miami Metro",
            cities: ["Miami", "Fort Lauderdale", "Boca Raton", "West Palm Beach", "Coral Gables", "Doral", "Aventura"]
        ),
    ...
    "ut": StateInfo(label: "Utah", metros: [
        "salt-lake-city": MetroInfo(
            label: "Salt Lake City / Utah Valley",
            cities: [
                "Salt Lake City",
                "Provo",
                "Orem",
    ...
    "oh": StateInfo(label: "Ohio", metros: [
        "columbus": MetroInfo(
            label: "Columbus",
            cities: ["Columbus", "Dublin", "Westerville", "New Albany", "Grove City"]
        ),
        "cleveland": MetroInfo(
            label: "Cleveland",
            cities: ["Cleveland", "Beachwood", "Independence", "Solon", "Strongsville"]
        ),
        "cincinnati": MetroInfo(label: "Cincinnati", cities: ["Cincinnati", "Blue Ash", "Mason", "Covington"])
    ]),
    "pa": StateInfo(label: "Pennsylvania", metros: [
        "philadelphia": MetroInfo(
