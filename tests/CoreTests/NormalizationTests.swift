...
final class SalaryNormalizerTests: XCTestCase {
    ...
    private func normalize(
        ...
        return SalaryNormalizer.normalize(extracted: extracted, preferredLocations: preferredLocations, sourceText: sourceText)
    }
    ...
    func testHourlyToAnnual2080Hours() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 176800)
        XCTAssertEqual(result["salary_max"] as? Int, 218400)
    }
    ...
    func testHourlyToAnnualWithoutSlashNotation() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 150800)
        XCTAssertEqual(result["salary_max"] as? Int, 187200)
    }
    ...
    func testHourlyWithCurrencyAfterNumber() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 104000)
        XCTAssertEqual(result["salary_max"] as? Int, 312000)
    }
    ...
    func testAnnualSalaryFromNote() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 185000)
        XCTAssertEqual(result["salary_max"] as? Int, 245000)
    }
    ...
    func testAnnualValuesWithCurrencyBeforeAndAfter() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 114000)
        XCTAssertEqual(result["salary_max"] as? Int, 148000)
    }
    ...
    func testCompactAnnualRangeWithCurrencyPrefix() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 179000)
        XCTAssertEqual(result["salary_max"] as? Int, 210000)
    }

    func testAnnualRangeWithCurrencyAfterSecondValue() {
        // Port of: 'parses annual ranges with currency after the second value'
        let result = normalize(note: "San Francisco Bay Area: 133400 - 226600 USD Annual; All Other US Locations: 116000 - 197000 USD Annual.")
        XCTAssertEqual(result["salary_min"] as? Int, 116000)
        XCTAssertEqual(result["salary_max"] as? Int, 226600)
    }
    ...
    func testDoesNotMixCADIntoUSD() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 200700)
        XCTAssertEqual(result["salary_max"] as? Int, 250900)
    }
    ...
    func testCompactKNotation() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 140000)
        XCTAssertEqual(result["salary_max"] as? Int, 200000)
    }
    ...
    func testMultipleBandsUseLowestAndHighest() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 185000)
        XCTAssertEqual(result["salary_max"] as? Int, 285000)
    }
...
"""
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 205000)
        XCTAssertEqual(result["salary_max"] as? Int, 216500)
    }
...
"""
    ...
    func testGeneralUSBandWhenMetroDoesNotMatch() {
        ...
        XCTAssertEqual(result["salary_min"] as? Int, 119800)
        XCTAssertEqual(result["salary_max"] as? Int, 234700)
    }
...
"""
        ...
        XCTAssertEqual(result["salary_currency"] as? String, "USD")
        XCTAssertEqual(result["salary_min"] as? Int, 133400)
        XCTAssertEqual(result["salary_max"] as? Int, 226600)
    }
...
"""
    ...
    func testLevelsFyiRemoteURLParam() {
        ...
        let extracted: [String: Any?] = ["remote_type": "unknown" as Any?, "location": nil, "company": "Zscaler" as Any?]
        let result = normalize(
            extracted,
...
final class LocationInferrerTests: XCTestCase {
    ...
    func testRecoverLocationFromMetadataLines() {
        ...
        let extracted: [String: Any?] = ["company": "Microsoft" as Any?, "title": "Senior Product Manager" as Any?, "location": nil, "remote_type": "unknown" as Any?]
        let result = normalize(extracted, description: "Title: Senior Product Manager\nLocation: United States, Multiple Locations, Multiple Locations\nWork site: 0 days / week in-office - remote")
    ...
    func testRemoteLocationWhenNoPhysical() {
        ...
        let extracted: [String: Any?] = ["company": "Reddit" as Any?, "title": "Principal Technical Program Manager" as Any?, "location": nil, "remote_type": "unknown" as Any?]
        let result = normalize(extracted, description: "Principal Technical Program Manager\nReddit · 8 days ago · Fully Remote")
    ...
    func testRecoverCityStateFromLineAfterTitle() {
        ...
        let extracted: [String: Any?] = ["company": "Pinterest" as Any?, "title": "Technical Program Manager II, Platforms" as Any?, "location": nil, "remote_type": "unknown" as Any?]
        let result = normalize(extracted, description: "Technical Program Manager II, Platforms\nSan Francisco, CA\n$103,965 - $214,044 a year")
    ...
    func testRecoverLocationFromHybridBasedInLanguage() {
        ...
        let extracted: [String: Any?] = ["company": "Zscaler" as Any?, "title": "Senior Product Manager" as Any?, "location": nil, "remote_type": "unknown" as Any?]
        let result = normalize(extracted, description: "This is a hybrid role based in San Jose, CA (3 days onsite). While local candidates are preferred, we are open to remote candidates based on the West Coast.")
    ...
    func testRemoteCountryContext() {
        ...
        let extracted: [String: Any?] = ["company": "Instacart" as Any?, "title": "Senior Technical Program Manager" as Any?, "location": nil, "remote_type": "remote" as Any?]
        let result = normalize(extracted, description: "Instacart\nSenior Technical Program Manager\nRemote - United States\nRole details")
    ...
    func testExpandsBareRemoteWithCountryContext() {
        ...
        let extracted: [String: Any?] = ["company": "Mercury" as Any?, "title": "Senior Product Manager" as Any?, "location": "Remote" as Any?, "remote_type": "remote" as Any?]
        let result = normalize(extracted, description: "Mercury\nSenior Product Manager\nRemote - United States or Canada\nRole details")
    ...
    func testOverridesBareCountryWithRemote() {
        ...
        let extracted: [String: Any?] = ["company": "Google Fiber" as Any?, "title": "Senior TPM" as Any?, "location": "USA" as Any?, "remote_type": "remote" as Any?]
...
final class CompanyBackfillerTests: XCTestCase {
    ...
    func testRecoverCompanyFromStructuredData() {
        ...
        let extracted: [String: Any?] = ["company": nil, "title": "Adobe Commerce Technical Program Manager (TPM)" as Any?]
...
final class DisplayNormalizerTests: XCTestCase {
    ...
    func testToStringArray() {
        ...
        XCTAssertEqual(DisplayNormalizer.toStringArray("Must have 5 years exp.") as? [String], ["Must have 5 years exp."])
...
final class LLMConstantsTests: XCTestCase {
    func testConstants() {
        XCTAssertEqual(LLMConstants.maxDescriptionChars, 32_000)
        XCTAssertEqual(LLMConstants.maxResumeChars, 12_000)
    }
}
